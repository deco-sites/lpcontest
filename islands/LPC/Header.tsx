...
import { Dropdown } from "deco-sites/lpcontest/components/lpc/Dropdown.tsx";
        ...
        >
          ...
          <ul class="flex flex-col gap-4">
            <li class="h-[50px] grid items-center">
              <a
                href={props.demo?.url}
                class="block px-6  font-normal text-[16px] leading-[19.36px] text-white hover:text-[#2FD180]"
              >
                {props.demo?.label}
              </a>
            </li>
