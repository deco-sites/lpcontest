...
export default function HowItWorks(
 ...
 <div className="w-[1280px] h-[625px] flex justify-center items-center gap-16">
              <div className="p-16 bg-[#000D0D] rounded-3xl flex-col justify-start items-center gap-10 flex">
						...
						<div>
							<p>Every 2 fridays we will announce a new Theme on Discord, sparking a 12-day marathon of design and development. It's your time to think, innovate, and execute. Example of themes: </p>
							<br/>
							<p>”Back to School": 🎒✏️ "Transform classroom boredom into a digital adventure! Create an educational portal where learning is as fun as playing a game. Bonus for interactivity and designs that make students forget they're studying!"</p>
							<br/>
							<p>
...
Ensure your submission stands out in 3 evaluation criterias: creativity, performance, and design.

Our team will then select the top 3 landing pages submitted and the community will decide who should win the 1st, 2nd and 3rd places.
                ...
                <a href="https://discord.com/channels/985687648595243068/1215655908630208512" target="_blank" className="px-8 py-3 absolute bottom-[56px] bg-[#02F67C] rounded-full justify-start items-center gap-2 inline-flex">
