    ...
    <section class="relative py-20 max-w-screen">
      <div class="mx-6 lg:container lg:mx-auto flex justify-center items-center flex-col gap-20">
        ...
        <div className="w-[1280px] h-[625px] flex justify-center items-center gap-16">
          <div className="p-16 bg-[#000D0D] rounded-3xl flex-col justify-start items-center gap-11 flex">
            <h3 className="text-white text-[40px] font-semibold font-['Albert Sans'] leading-[48px]">
              Challenge Timeline
            </h3>
            ...
            {
              /* <div className="px-8 py-3 bg-emerald-500 rounded-[99px] justify-start items-center gap-2 inline-flex">
                  <div className="text-black text-xl font-medium font-['Albert Sans']">
